# explainability_real_units_with_lime.py
...
def run_explainability(model_path, scaler_path, states_csv, doses_csv, vis_dir, plot=True, n_samples=50):
    ...
    if plot:
        ...
        shap.summary_plot(shap_values, X_real,
                          ...
                          show=False)
        summary_file = os.path.join(vis_dir, "shap_summary_real_units.png")
        plt.tight_layout()
        ...
        for i, feature in enumerate(feature_names):
            ...
            dep_file = os.path.join(vis_dir, f"shap_dependence_{feature}.png")
            plt.tight_layout()
        ...
        for idx in sample_indices:
            ...
            lime_file = os.path.join(vis_dir, f"lime_explanation_{idx}.html")
